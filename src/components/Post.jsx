...
export default function Post({post}){
    ...
    return(
        <div className="w-full max-w-2xl min-h-70 flex flex-col justify-between p-8 bg-gray-100 rounded-2xl shadow-xl border border-gray-200 hover:shadow-2xl cursor-pointer trasistion-all duration-300 m-auto" onClick={()=> navigate(`/PostDetail/${post.id}`)}>
            <div >
                ...
                <p className="text-gray-700 text-xl leading-relaxed line-clamp-3">
                {post.content}
                </p>
            </div>
        </div>
